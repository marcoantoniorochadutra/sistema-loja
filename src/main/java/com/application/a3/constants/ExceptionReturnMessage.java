package com.application.a3.constants;

public class ExceptionReturnMessage {
	
	
	public static final String INFORMACAO_NULA = "Campo deve ser preenchido";
	public static final String ARGUMENTO_INVALIDO = "A Operação falhou.";
	public static final String TAMANHO_INVALIDO = "Informação com tamanho inválido";
	public static final String DADO_DUPLICADO = "Registro já existe";
